...
const translations = {
  zh: {
    ...
    sync_stored_procedure: '同步存储过程',
    overwrite_stored_procedure: '覆盖存储过程',
    status_running: '运行中',
  ...
  en: {
    ...
    sync_stored_procedure: 'Sync Stored Procedures',
    overwrite_stored_procedure: 'Overwrite Stored Procedures',
